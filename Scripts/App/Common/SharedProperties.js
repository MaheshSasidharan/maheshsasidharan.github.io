MSPortfolio
.factory('SharedProperties', ['Factory_CommonRoutines', 'Factory_Constants', '$timeout', '$interval', SharedProperties])

function SharedProperties(CommonRoutines, Constants, timeout, interval) {
    var oSP = {
